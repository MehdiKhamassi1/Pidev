...
#[Route('/map', name: 'app_map_show', methods: ['GET'])]
public function showMapAction()
{
    // Retrieve latitude and longitude from wherever you have them stored, database, API, etc.
    $latitude = 36.899449666087314;
    $longitude = 10.189466454036472; 

    return $this->render('organisation/map.html.twig', [
        'latitude' => $latitude,
        'longitude' => $longitude
    ]);
}
